...
public class File01 {
	...
	public static void main(String[] args) {
		 ...
		 * 입력 : inputStream / 출력 : outStream (IOStream) --> 단방향으로 흘러가는 형태
		 * 다양한 장치에 독립적으로 운영됨
		 * 일관성있게 입출력을 유지하기 위해 사용
		 * 데이터의 형태 : 바이트 / 문자 스트림 으로 구분
		 * 바이트 : 그림, 영상, 실행파일...
		 * 문자 : 문자를 입출력할 때 사용
		
		 * 바이트스트림
		    - 입력 : FileInputStream, BufferedInputStream...
		  	- 출력 : FileOutputStream, BufferedOtuputStream...
		 * 문자스트림 : encoding 처리를 해줌
		  	- 입력 : FileReader, BufferedReader, InputStreamReader...
		  	- 입력 : FileWriter, BufferedWriter, PrintWriter...  
