...
public class BankController {
	...
	public void addCustomer() {
		...
		bank.get(0).addCustomer(new Customer(bank.get(0).getBankName(), "신짱구", "1003", 10000));
		
		// 신한은행
		bank.get(1).addCustomer(new Customer(bank.get(1).getBankName(), "홍길동", "2001", 10000));
		bank.get(1).addCustomer(new Customer(bank.get(1).getBankName(), "신짱아", "2002", 10000));
